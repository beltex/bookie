    ...
    <div class="container">
      ...
      <form class="form-signin">		
		<div class="input-group">
  			...
  			<input id="topics5" type="text" class="form-control " placeholder="Who owe's you?">
		</div>
		</form>
